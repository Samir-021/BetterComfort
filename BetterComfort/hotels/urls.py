...
# Register custom float converter for latitude / longitude parameters
...
urlpatterns = [
    ...
    path('details/<str:lat>/<str:lon>/<str:name>/', views.hotel_details, name='hotel_details_str'),
    path('favorites/', views.favorites_list, name='favorites_list'),
    path('favorites', views.favorites_list),  # Backward compatibility without trailing slash
